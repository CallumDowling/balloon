...
impl GraphicsPipelineWrapper for Teapot_v2 {
    ...
    fn create(
        ...
        let pipeline = {
            ...
            let rasterization_state = RasterizationState::default().cull_mode(CullMode::Back);
            //info!("Front face: {:?}", rasterization_state.front_face);
